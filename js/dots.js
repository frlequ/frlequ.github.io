...
function updateCoverHeight() {
  ...
  // Find all elements with the class .cover
  var covers = document.querySelectorAll('.cover');

  // Loop through the NodeList of .cover elements
  covers.forEach(function(cover) {
    // Set each .cover element's height to match the screen height
    cover.style.height = screenHeight + 'px';
  });
}

// Call the function to update the height on initial load
updateCoverHeight();
